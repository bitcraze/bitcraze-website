...
class TestNotice < Testbase
  ...
  def test_that_info_tag_is_rendered
    ...
    expected = '<div class="alert alert-success"><i class="fa-solid fa-info fa-fw"></i>My message</div>'
  ...
  def test_that_important_tag_is_rendered
    ...
    expected = '<div class="alert alert-danger"><i class="fa-solid fa-triangle-exclamation fa-fw"></i>My message</div>'
