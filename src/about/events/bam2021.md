...
*Please let us know if you signed up and you haven't received an email from the [event platform Welkom](#event-platform) with a personal access link by now. Also let us know if you have any problem accessing the event platform! Please email contact@bitcraze.io*
...
Using the latest version of google chrome, microsoft edge or any other chromium browser is advises. Firefox has been reported to work for the regular talks and the event platform, but it will not work for the Mibo intergration.
