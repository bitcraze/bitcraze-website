...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><i class="fa fa-coffee"></i><a href="#fk"> Fika</a></td>
      <td><i class="fa fa-coffee"></i><a href="#fk"> Fika</a></td>
      <td>Panel: Swarm Management tools with <br> Jonas Danielsson (BC) & <a href="#wh">Wolfgang Hönig</a>  </td>
    </tr>
    <tr>
      <td>12:30</td>
    ...
    <tr>
      <td>13:30</td>
      <td rowspan="2"><a href="#jd">Joseph La Delfa</a> (KTH): <br>Topic: Moving a drone with your whole body</td>
    ...
    <tr>
      <td>17:30</td>
      <td rowspan="2"><i class="fa fa-gamepad"></i> <a href="#qz"> Quiz!</a></td>
      <td rowspan="2"><i class="fa fa-group"></i> <a href="#cr"> Community Roundtable Q&amp;A </a></td>
      <td>Future plans of Bitcraze</td>
    </tr>
    <tr>
      <td>18:00</td>
      <td><i class="fa fa-glass"></i> <a href="#cp"> Closing party </a></td>
    </tr>
  </tbody>
</table>
...
We will be doing this in MiBo rooms, as we discovered this special chat tool, called [MiBo](https://getmibo.com/), during the worst of the pandamic. We felt that this was the closet thing to being actually in the same room, and therefore we would like you all to use this for the Fika discussions during the BAMdays!

####  <i class="fa fa-gamepad"></i> Quiz {#qz}

A quiz about everything crazyflie and Bitcraze, you don't want to miss this!
...
{% img bart and guido; narrow; /images/events/bam2021/bartguido.png %}
...
For the BAM days we will be using the [Welkom platform](https://welkom.world/en/) which is originally from the Netherlands. This also integrates a lot of cool external tools, so we are exited to talk to everybody in the spatial chat program called [MiBo](https://getmibo.com/). 
