...
{% img Daniele Palossi; narrow; /images/events/bam2021/Fransesco.png %}
...
Rust is a relatively new modern and safe programming language that aim at giving the low level control of C with the productivity of higher-level language. It is starting to be a quite popular system programming language but is also able to replace C in embedded systems. In this workshop we will have a quick look at the language and its potential application at Bicraze. We will then implement a Crazyflie app that runs onboard the quadcopter, the push demo, in Rust.
