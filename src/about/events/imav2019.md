...
{% img IMAV 2019; narrow; /images/events/imav2019/imav2019.jpg %}

We will exhibit at IMAV 2019 in Madrid between 1-4 August.
...
We will show the new Crazyflie<sup>®</sup> Bolt, the AI deck and other products that will be released in the near future.

-----

## Demo
This section describes the demo we are running at IMAV 2019 with links to required
...
The source code for the demo is available on [GitHub](https://github.com/bitcraze/crazyflie-firmware-experimental/tree/imav-2019).
Most of the functionality in the firmware is implemented in [app.c](https://github.com/bitcraze/crazyflie-firmware-experimental/blob/imav-2019/src/modules/src/app.c) and
the Control tower is implemented in [control_tower.py](https://github.com/bitcraze/crazyflie-firmware-experimental/blob/imav-2019/control_tower/control_tower.py).
