...
For the tutorial we will assume that you already know the Crazyflie<sup>®</sup> and have done some development for it in some way, so the introduction to our ecosystem will be very brief.
