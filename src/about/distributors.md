...
{% country South Korea %}
{% distributor Clrobur; https://www.clrobur.com/en/sub0203.php; /images/distributors/clrobur.png %}
...
{% country France %}
{% distributor Génération Robots; https://www.generationrobots.com/fr/322-drones-programmables; /images/distributors/generation-robots.jpg %}

{% country Germany %}
{% distributor Exp-tech; https://exp-tech.de/collections/bitcraze; /images/distributors/exp_tech_logo_600.png %}
{% distributor Génération Robots; https://www.generationrobots.com/de/322-programmierbare-drohnen; /images/distributors/generation-robots.jpg %}
...
{% distributor Unmanned tech; https://www.unmannedtechshop.co.uk/search?q=crazyflie&options%5Bprefix%5D=last; /images/distributors/unmanned_tech.png %}
{% distributor Rahal Tec; https://rahal.co.uk/crazyflie/; /images/distributors/rahal_tec.jpg %}

{% continent North America %}
{% distributor Unmanned tech; https://www.robotshop.com/search?q=Bitcraze; /images/distributors/robotshop-logo.png %}
