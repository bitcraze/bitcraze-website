...
This might sound unusual, but we have developed a robust way of working that guides our daily collaboration without limiting creativity. At Bitcraze, you will never be a cog in a machine. You will be part of building the machine itself.

### Location and Practicalities

We are based in Malmö, Sweden, and we believe deeply in the value of human connection. Collaboration, learning, and innovation happen best when people share the same space, so we limit remote work. 
...
Support and guide users around the world through GitHub, forums, email, and other channels. Problems range from basic setup questions to highly complex engineering challenges. You will learn a lot and help others do the same.

### Systems and Infrastructure
Maintain and evolve the systems that make Bitcraze run: websites, build pipelines, discussion platforms, internal tools, supply chain tracking, and more.

### Business and Strategy
Think beyond code. Explore new application areas, define long-term strategy, and contribute to how Bitcraze grows sustainably and responsibly in the future.

### Operations and Logistics
Ensure that our products reach users efficiently and reliably. Work with production partners, manage supply chains, and help optimize the way we deliver hardware worldwide.
...
If you believe technology should be open, if you want to work in a team where decisions are shared and ideas are valued, and if you are excited by the idea of contributing to a global robotics community, then we would love to hear from you.

## Apply
If you feel that Bitcraze could be the right place for you, tell us about yourself, what excites you, and how you would like to contribute.