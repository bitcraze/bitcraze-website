      ...
      <div class="col-12 col-md-7 text-box_platform d-flex align-items-center">
        <div>
          ...
          <ul class="app-concept-list">
            <li>Adaptive control algorithms that respond to disturbances, noise, and model uncertainty.</li>
            <li>Reinforcement learning approaches for motion control, energy optimization, and decision-making.</li>
    ...
    <div class="row g-3 mt-4">
      <div class="col-12 col-md-4">
        <div class="app-bundle-card">
          ...
          <div class="app-bundle-name">Infinite flight bundle - Crazyflie 2.1 Brushless</div>
          <p class="app-bundle-desc">Take your autonomous flying experience to the next level with the Infinite Flight Bundle. This complete package provides everything you need to keep your Crazyflie 2.1 Brushless in the air 24/7—with seamless landings and automated charging for continuous operation.</p>
          <a href="https://store.bitcraze.io/collections/bundles-crazyflie-2-1-brushless/products/infinite-flight-bundle-crazyflie-2-1-brushless" class="btn btn-color-primary">Shop Bundle</a>
        </div>
      </div>
      <div class="col-12 col-md-4">
        <div class="app-bundle-card">
