...
<div class="container app-page-header">
  <h1 class="app-page-title">Swarm Robotics</h1>
</div>

<!-- ── Section 1: Intro ──────────────────────────────────────────────────── -->
<div class="container app-intro-section">
  <h2 class="text-center">
    Coordinating <span class="highlight-green">Collective</span> Intelligence
  </h2>
      ...
      <div class="col-12 col-md-7 text-box_platform d-flex align-items-center">
        <div>
          ...
          <ul class="app-concept-list">
            <li>Formation flight and cooperative control.</li>
            <li>Distributed localization and communication.</li>
            <li>Task allocation and swarm learning.</li>
            <li>Emergent behavior and collective adaptation.</li>
            <li>Hybrid simulation–real experiments.</li>
            <li>Collective mapping, exploration, and environmental monitoring.</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row g-3 mt-4">
      ...
      <div class="col-12 col-md-6">
        <div class="app-bundle-card">
          ...
          <div class="app-bundle-tag">Featured</div>
          <div class="app-bundle-name">Loco Swarm bundle - Crazyflie 2.1 Brushless</div>
          <p class="app-bundle-desc">With the swarm bundle you will get your very own swarm of Crazyflie Brushless.</p>
      ...
      <div class="col-12 col-md-6">
        <div class="app-bundle-card">
          ...
          <div class="app-bundle-tag">Featured</div>
          <div class="app-bundle-name">Lighthouse swarm bundle - Crazyflie 2.1+</div>
          <p class="app-bundle-desc">With the Lighthouse swarm bundle, you will get your very own swarm of Crazyflies.</p>
      ...
      <div class="col-12 col-md-6">
        <div class="app-bundle-card">
          ...
          <div class="app-bundle-tag">Featured</div>
          <div class="app-bundle-name">Loco Swarm bundle - Crazyflie 2.1+</div>
          <p class="app-bundle-desc">With the swarm bundle you will get your very own swarm of Crazyflies.</p>
          <a href="https://store.bitcraze.io/collections/bundles-crazyflie-2-1/products/loco-swarm-bundle" class="btn btn-color-primary">Shop Bundle</a>
        </div>
      </div>
    </div>
  </div>
...
<div class="container-fluid appl-landing-cta" id="appl-cta">
  <div class="row justify-content-center">
    <div class="col-md-8 text-center">
      ...
      <p>Whether for formation control, cooperative mapping, or multi-agent learning, the Crazyflie offers a compact and trusted research platform for swarm robotics.</p>
