...
The Flow breakout board is used for motion tracking and can easily be connected 
...
The expansion ports on the Crazyflie 2.0 enables you to connect more or less
any hardware you like. When prototyping the Breakout deck is useful as you can 
use it to connect your Crazyflie 2.0 to a bread board and easily debug your 
...
why not manufacture a deck PCB and add Female deck connectors.
...
The Crazyflie 2.0 is fun to fly as is but adding the LED-ring deck and flying
...
The BigQuad deck is used to control a bigger quad copter frame with a Crazyflie 2.0.
...
Flying a quad copter like the Crazyflie manually requires some skill and 
...
**What to buy:** [Indoor Explorer bundle](https://store.bitcraze.io/collections/bundles/products/indoor-explorer-bundle), 
[2 anchors](https://store.bitcraze.io/collections/positioning/products/loco-positioning-node), 
...
There are frameworks (Crazy Swarm) written by the community to handle these types of system and
