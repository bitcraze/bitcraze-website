...
module Jekyll
  ...
  class CollapseSection < Liquid::Block
    ...
    def render(context)
      opening_tags = '<div class="collapse-section"><a href="#CollapseSection%1$s" data-bs-toggle="collapse" data-bs-target="#CollapseSection%1$s"><strong>%2$s</strong></a><div id="CollapseSection%1$s" class="collapse">' % [@@id, @params[0]]
