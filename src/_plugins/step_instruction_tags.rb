...
module Jekyll
  module StepInstruction
    ...
    # Use this tag to create part in the tutorial
    #
    ...
    # {% endsi_part %}
    #
    # {% si_part My title; optional-id %}
    # Some content (supports markdown)
    # {% endsi_part %}

    class Part < Liquid::Block
      ...
      def render(context)
        ...
        '<div class="step-instruction-part"><h1 id="%1$s">%2$s</h1>%3$s</div>' % [full_id, @params[0], markup]
      end
...
Liquid::Template.register_tag('si_part', Jekyll::StepInstruction::Part)
