...
The {% poplink multi-ranger-deck%} measures the distance to the nearest surface in five directions around the Crazyflie<sup>®</sup> 2.x - front, back, left, right, and up - with millimeter precision up to 4 meters.
