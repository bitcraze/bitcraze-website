...
{% row_text %}
The Crazyflie<sup>®</sup> family members are the  **{% id_link product-crazyflie-2-1-plus %}** nano quadcopter, the  **{% id_link product-crazyflie-2-1-brushless %}** nano quadcopter and the **{% id_link product-crazyflie-bolt-1-1 %}** quadcopter controller. They are all based on similar hardware but
