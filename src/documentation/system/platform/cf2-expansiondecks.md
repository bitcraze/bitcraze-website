...
|---|---|---|---|---|
| ![Short pins](/images/documentation/overview/short_pins.webp){:width="200px"} | Short Pins | Included with the Crazyflie 2.x.<br>[Availablie in store (combined with medium pins)](https://store.bitcraze.io/products/short-and-medium-pins) | Best suited for manual flight with only the **Battery Holder Deck** mounted on top. | 9mm x 2 mm x 2mm | [Datasheet](/documentation/hardware/male_longer_deck_connector/male_longer_deck_connector-datasheet.pdf) |
