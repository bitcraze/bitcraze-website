...
As explained in the [vision main page the Crazyflie<sup>®</sup> vision system](/documentation/tutorials/fly-with-kinect/) is modular and is composed of many programs:
