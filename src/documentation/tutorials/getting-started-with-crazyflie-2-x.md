...
* In the Crazyflie client choose the correct __Address__. The default one is 0xE7E7E7E7E7. To figure out or change the Address of your Crazyflie, you can follow the [radio address configuration](/documentation/repository/crazyflie-clients-python/master/userguides/userguide_client/#firmware-upgrade) guide.
