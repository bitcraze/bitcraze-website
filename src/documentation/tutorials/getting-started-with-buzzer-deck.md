...
The {% poplink buzzer-deck %} contains a low profile piezo buzzer and has a 1-wire memory which enables the Crazyflie<sup>®</sup> to automatically detect the buzzer.
