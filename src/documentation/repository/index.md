...
|![Crazyradio 2.0](/images/documentation/overview/crazyradiopa.png){:width="50px"}|  [crazyradio-2-0-firmware](https://github.com/bitcraze/crazyradio2-firmware) | [Docs](/documentation/repository/crazyradio2-firmware/main/) | This GitHub repository contains the source code for the firmware of the {% id_link product-crazyradio-2-0 %}.|
