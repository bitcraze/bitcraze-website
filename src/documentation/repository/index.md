...
|![pc with crazyflie radio PA](/images/documentation/overview/pc.png){:width="50px"}|  [crazyflie-lib-python](https://github.com/bitcraze/crazyflie-lib-python) | [Docs](/documentation/repository/crazyflie-lib-python/master/) | This GitHub repository contains the source code for the python library client to control the Crazyflie<sup>®</sup> from the PC. This is the stable library that the cfclient and most examples are built on. The documentation also includes the instructions to handle the USB access rights for the {% id_link product-crazyradio-pa %}.|
|![pc with crazyflie radio PA](/images/documentation/overview/pc.png){:width="50px"}|  [crazyflie-lib-python-v2](https://github.com/bitcraze/crazyflie-lib-python-v2) | [README](https://github.com/bitcraze/crazyflie-lib-python-v2/blob/main/README.md) | This GitHub repository contains the source code for cflib2, an async-first rewrite of the python library, in which the link and protocol handling are implemented in Rust and exposed to python with PyO3. It is installed and imported as a normal python package, but it is not a drop-in replacement for [crazyflie-lib-python](https://github.com/bitcraze/crazyflie-lib-python) and the API is not stable yet, so expect breaking changes.|
...
|![Crazyradio 2.0](/images/documentation/overview/crazyradiopa.png){:width="50px"}|  [crazyradio-2-0-firmware](https://github.com/bitcraze/crazyradio2-firmware) | [Docs](/documentation/repository/crazyradio2-firmware/main/) | This GitHub repository contains the source code for the firmware of the {% poplink crazyradio-2-0 %}.|
